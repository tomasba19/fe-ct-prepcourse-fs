...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var sumaArreglo = arrayOfNums.reduce(
      (a, d) => a + d,);
   return sumaArreglo;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var promedioSuma = resultadosTest.reduce(
      (a,d) => a + d
      );
   var promedioTest = promedioSuma / resultadosTest.length;
   return promedioTest;
   //HACER DE NUEVO PERO CON BUCLE
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numeroGrande = arrayOfNums.reduce(function(a, b){
      return Math.max(a, b);
   }
   )
   return numeroGrande;
